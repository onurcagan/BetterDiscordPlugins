...
module.exports = (() => {
  const config = {
    info: {
      ...
      github:
        "https://github.com/onurcagan/BetterDiscordPlugins/blob/master/Easymotes.plugin.js",
      github_raw:
        "https://raw.githubusercontent.com/onurcagan/BetterDiscordPlugins/master/Easymotes.plugin.js",
    },
    defaultConfig: [
      {
        type: "category",
        ...
        settings: [
          ...
          },
          {
            ...
            value: "",
            note:
              'E.g. For ">" as the suffix Kappa> will work as intended. Suggestion; leave empty for ease of use.',
          },
        ],
      },
    ],
          ...
          return class Easymotes extends Plugin {
            ...
            findEmote(name) {
              const libraries = [
                ...
                "BTTV",
                "BTTV2",
              ].map((lib) => BdApi.emotes[lib]);

              for (const emotes of libraries) {
                if (emotes[name]) {
                  return emotes[name];
                }
              }
